...
if __name__ == "__main__":
    ...
    smoke_prompts = [
        ...
        "How do I structure the executive summary of a vision document?",
        "What are the key sections of a Component Vision Document?",
        "Explain the difference between goals and objectives in a vision document.",
        "How do I define success criteria in a vision document?",
        "What stakeholders should be involved in creating a vision document?",
        "How do I document architectural decisions in a vision document?",
        "What is the purpose of the scope section in a vision document?",
        "How do I write a compelling problem statement for a vision document?",
        "What constraints should be documented in a vision document?",
        "How do I capture assumptions in a vision document?",
        "What risks should be identified in a vision document?",
        "How do I describe the target audience in a vision document?",
        "What is the role of the coordinator agent?",
        "How do I use the batch processing feature?",
        "What tools does the coordinator agent have access to?",
        "How do I monitor batch job progress?",
        "What happens when a batch record fails?",
        "How do I retry failed batch records?",
        "How do I configure tracing for batch jobs?",
        "What metrics are captured during batch processing?",
    ]
